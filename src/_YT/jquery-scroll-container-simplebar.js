    ...
    ********************************************/
    ...
    function SimpleBar( element, options ) {
        ...
        this.onEndDrag = function (e) {
            ...
            //** Remove simplebar-dragging to the track and scrollbar-elements of the
            _this.axis[_this.draggedAxis].track.el.classList.remove(_this.classNames.dragging);
            _this.axis[_this.draggedAxis].scrollbar.el.classList.remove(_this.classNames.dragging);
   ...
   */
    ...
    */
    _proto.onDragStart = function onDragStart(e, axis) {
        ...
        //** Add simplebar-dragging to the track and scrollbar-elements of the
